          ...
          <table border=1 id="pronostiek">
            ...
            <?php foreach($json as $group): ?>
              ...
              <?php foreach($group["matches"] as $match): ?>
                ...
                $vlag_thuis = file_exists("images/vlaggen/" . $match["thuis"] . ".jpg") ? "images/vlaggen/" . $match["thuis"] . ".jpg" : "vlaggen/default.png"; 
                $vlag_uit =  file_exists("images/vlaggen/" . $match["uit"] . ".jpg") ? "images/vlaggen/" . $match["uit"] . ".jpg" : "vlaggen/default.png";

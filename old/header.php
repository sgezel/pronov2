                ...
                <div class=row>
                    <ul>
                        ...
                        <?php if($config["enable_login"]): ?>
                            ...
                            <?php else: ?>
                                <li><a href="refresh.php" style="color: #ccfc53;">Punten Herberekenen</a></li>
                            ...
                            <div class=nav-wrapper>
                                ...
                                <div class=nav-menu>
                                    <ul class="nav navbar-nav menu-bar">
                                        ...
                                        <li><a href="overzicht.php" class="<?= (basename($_SERVER['PHP_SELF']) === "overzicht.php") ? "active" : "";  ?>">Overzicht <span></span> <span></span> <span></span> <span></span></a>

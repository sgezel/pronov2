...
class SettingCrud
{
    ...
    public function __construct($filePath = 'data.json')
    {
        ...
        if (file_exists($filePath)) {
            ...
            $this->attributesList = ["baseurl","apikey","registrations", "questionvalue","questionslocked", 
                                    "round1", "round2", "round3", "round4", "round5",
                                     "smtp_host", "smtp_port", "smtp_user", "smtp_password", "sponsor", 
                                     "bonuspointsmatches" ,"bonuspoints", "scoreboardequalplace"];
        } else {

          ...
          <table class="email-content" width="100%" cellpadding="0" cellspacing="0" role="presentation">
            <tr>
              <td class="email-masthead">
                <a href="https://pronostiek.codepage.be" class="f-fallback email-masthead_name">
                <?= $title; ?>
              </a>
              </td>
            </tr>
           ...
           https://litmus.com/blog/a-guide-to-bulletproof-buttons-in-email-design -->
                        ...
                        <p>Groetjes,
                          <br>Sandor en Dieter</p>
                        <!-- Sub copy -->
                        <table class="body-sub" role="presentation">
                          <tr>
                            <td>
                              <p class="f-fallback sub">Als het niet lukt om het wachtwoord in te stellen met bovenstaande knop, kopieer en plak deze link dan in he browser.</p>
